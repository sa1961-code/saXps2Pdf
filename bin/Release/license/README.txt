...
saXps2Pdf is licensed under the terms of the GNU GPL.

Source code and other binaries can be obtained from https://github.com/sa1961-code/saXps2Pdf

== GhostXPS ==

Source code and other binaries can be obtained from http://ghostscript.com/
The included GhostXPS modules are licensed under the terms of the GNU AGPL.
